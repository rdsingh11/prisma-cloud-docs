...
** In xref:./configure-accounts/configure-aws.adoc[AWS]: Specify the deployed Security group.

** In xref:./configure-accounts/configure-azure.adoc[Azure]: Specify the deployed Security group ID and Subnet ID.
